...
public class FormListaEstados extends javax.swing.JFrame {
    ...
    private ArrayList<Estados> carregarLinhas() {
        ...
        ArrayList<Estados> minhaLista = new ArrayList<Estados>();

        minhaLista.add(Estados.criar(1, "PIX", ""));
        minhaLista.add(Estados.criar(1, "Créito", ""));
        minhaLista.add(Estados.criar(1, "Débito", ""));
        minhaLista.add(Estados.criar(1, "Dinheiro", ""));
        minhaLista.add(Estados.criar(1, "Boleto", ""));
        minhaLista.add(Estados.criar(1, "Cheque", ""));
